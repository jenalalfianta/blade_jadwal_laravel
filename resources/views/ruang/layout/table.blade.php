<p>
    <a href="{{ route('ruang.create') }}" class="focus:outline-none text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-7 py-3 mr-1 mb-1 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Tambah Data</a>
</p>
...
<table class="my-8 w-full text-sm text-left text-gray-500 dark:text-gray-400">
    ...
    <tbody>
        ...
        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
            ...
            <td class="px-6 py-4">
                <a href="{{ route('ruang.edit', $ruang->id) }}" class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-3 py-2 mr-1 mb-1 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Edit</a>
                <form style="display:inline-block" action="{{ route('ruang.update', $ruang->id) }}" method="POST">
                    @method('DELETE')
                    @csrf
