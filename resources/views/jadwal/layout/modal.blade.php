    ...
    <div id="close" class="relative w-full h-full max-w-2xl md:h-auto">
        ...
        <div id="modal" class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="px-6 py-6 lg:px-8">
                ...
                <form id="jadwalAddForm" method="post" class="space-y-6" action="{{route('jadwal.store')}}">
                @csrf
            ...
            <div class="px-6 py-6 lg:px-8">
                ...
                {{-- <input type="hidden" name="user" value="{{Auth::user()->id}}"> --}}
                    <div>
                        ...
                        <x-input-error :messages="$errors->get('titleEdit')" />
                    </div>
                    ...
                    <div>
                        ...
                        <x-input-error :messages="$errors->get('ruangEdit')" class="mt-2" />
                    </div>
                    ...
                    <div>
                        ...
                        <x-input-error :messages="$errors->get('startDateEdit')" class="mt-2" />
                    </div>
                    ...
                    <div class="grid gap-4 mb-4 sm:grid-cols-2">
                        <div>
                            ...
                            <x-input-error :messages="$errors->get('startTimeEdit')" class="mt-2" />
                        </div>
                        <div>
                            ...
                            <x-input-error :messages="$errors->get('endTimeEdit')" class="mt-2" />
                        </div>
                    </div>
