              ...
              <div class="px-6 py-6 lg:px-8">
                  ...
                  <form class="space-y-6" action="#">
                    ...
                    @csrf
                      <div>
                        {{-- :value="old('title') --}}
                        <label for="title" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama Kegiatan</label>
                        <input id="title" type="title" name="title" " class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="Ketik disini.." required>
